...
def generate_launch_description():
    ...
    models_path = os.path.join(get_package_share_directory('turtlebot3_gazebo'), 'models')
    world_path = os.path.join(get_package_share_directory('turtlebot3_gazebo'), 'worlds')
